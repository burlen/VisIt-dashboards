...
if (ALWAYS_UPDATE OR (nUpdated GREATER 0))
    ctest_submit(PARTS Update RETRY_DELAY 15 RETRY_COUNT 10)
    ctest_read_custom_files("${CTEST_BINARY_DIRECTORY}")
    ctest_configure()
    ctest_submit(PARTS Configure RETRY_DELAY 15 RETRY_COUNT 10)
    ctest_build()
    ctest_submit(PARTS Build RETRY_DELAY 15 RETRY_COUNT 10)
    ctest_test()
    ctest_submit(PARTS Test RETRY_DELAY 15 RETRY_COUNT 10)
    ctest_submit(PARTS Notes RETRY_DELAY 15 RETRY_COUNT 10)
endif()
